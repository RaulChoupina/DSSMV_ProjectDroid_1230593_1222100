...
public class BookAdapter extends RecyclerView.Adapter<BookAdapter.VH> {
    ...
    // FIX: não reatribuir a lista final; limpar e adicionar
    ...
    public void onBindViewHolder(@NonNull VH h, int pos) {
        ...
        String author = (b.authors != null && !b.authors.isEmpty() && b.authors.get(0) != null)
                ? (b.authors.get(0).name != null ? b.authors.get(0).name : "Autor desconhecido")
                : "Autor desconhecido";
